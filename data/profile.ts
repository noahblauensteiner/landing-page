...
competing in beach volleyball, or out in Dutch nature.`,
  ...
  // ── Reference projects (from CV + recent work) ─────────────────────────────
  projects: [
    {
      id: 'proj-kotlinconf',
      name: 'Xebia KotlinConf Game',
      client: 'Xebia @ KotlinConf',
      period: '2025',
      role: 'Creator — built 100% with AI',
      description:
      ...
      impact: 'Idea → conference-ready in one week, zero hand-written code. Play it live.',
      stack: ['AI-assisted development', 'Anthropic toolchain', 'Web game', 'Netlify'],
    ...
    },
    {
      ...
      stack: ['Technical architecture', 'Security', 'Cross-team integration', 'Scrum at scale'],
    },
    {
      id: 'proj-kleinanzeigen',
      name: 'Frontend Architecture & Enablement',
      client: 'Kleinanzeigen & others',
      period: 'Sep 2022 – Mar 2024',
      role: 'Lead Developer',
      description:
        'After relocating to Amsterdam, project-hopped across teams to prepare their architectures for bigger teams and future requirements. At Kleinanzeigen, brought in frontend expertise to simplify the frontend setup of one of Germany’s biggest classifieds platforms.',
      impact:
        'Uncovered, investigated and fixed a bug causing constant double page reloads — and shared the findings across teams at Kleinanzeigen.',
      stack: ['TypeScript', 'Frontend architecture', 'Team enablement'],
    },
    {
      ...
      stack: ['Team leadership', 'Architecture design', 'Agile delivery'],
    },
    {
      id: 'proj-portfolio',
      name: 'This Portfolio',
